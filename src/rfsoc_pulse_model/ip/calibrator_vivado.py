...
def emit_calibrator_vivado_tcl() -> str:
    ...
    lines = [
        ...
        "add_files -norecurse [list [file join $source_dir rtl calibrator_core.sv] [file join $source_dir rtl calibrator_control_axi.sv] [file join $source_dir rtl calibrator_control_cdc.sv] [file join $source_dir rtl axis_dac_mute_gate.sv]]",
