...
def emit_calibrator_vivado_tcl() -> str:
    ...
    lines = [
        ...
        "add_files -norecurse [list [file join $source_dir rtl calibrator_core.sv] [file join $source_dir rtl calibrator_control_axi.sv] [file join $source_dir rtl calibrator_control_cdc.sv]]",
        "set_property FILE_TYPE {Verilog} [get_files [list calibrator_core.sv calibrator_control_axi.sv calibrator_control_cdc.sv]]",
    ...
    for channel in range(8):
        lines.extend(
            [
                ...
                f"connect_bd_intf_net [get_bd_intf_pins {{adc{channel}_broadcaster/M00_AXIS}}] [get_bd_intf_pins {{rfdc_0/{_ADC_TO_DAC[channel]}}}]",
    ...
    lines.extend(
        [
            ...
            "  connect_bd_net [get_bd_pins {ps_0/pl_clk1}] [get_bd_pins adc${channel}_iq_combiner/aclk] [get_bd_pins adc${channel}_iq_subset/aclk] [get_bd_pins adc${channel}_rx_slice/aclk] [get_bd_pins adc${channel}_broadcaster/aclk]",
