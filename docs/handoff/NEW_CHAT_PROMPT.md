...
Live-check git branch, HEAD, status, worktrees, and the implementation anchor commit 89a2362.
...
2. whether commit 89a2362 exists and is an ancestor of HEAD;
3. whether config root/package mirrors and the production lock still match;
4. the two active Task 5 blockers from docs/handoff/OPEN_ISSUES.md;
5. the next allowed step from docs/handoff/NEXT_STEPS.md;
